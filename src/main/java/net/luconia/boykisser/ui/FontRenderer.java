...
public class FontRenderer {
    ...
    public void drawString(String text, float x, float y, Color color) {
        ...
        String[] parts = STRIP_COLOR_PATTERN.split(text);
    ...
    public float getWidth(final String text) {
        String textWithOutColorCodes = STRIP_COLOR_PATTERN.matcher(text).replaceAll("");
    ...
    public float getHeight(final String s) {
        return this.unicodeFont.getHeight(s) / antiAliasingFactor;
    }
}