...
public class PingDisplay extends Module {
    ...
    public transient String text = "%ping% ms";

    public PingDisplay() {
        super("Ping Display", "Displays your current ping to the server", Category.VISUAL);
    }
    ...
    public void render() {
        ...
        String textToRender = text.replace("%ping%", getPlayerPing());
